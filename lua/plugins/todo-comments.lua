return {
    {
        ...
        opts = {
            -- Default options are copied here for reference, but some changes have been made
            signs = true,      -- show icons in the signs column
            sign_priority = 8, -- sign priority
            -- keywords recognized as todo comments
            keywords = {
                -- NOTE: Any updates to these keywords should be mirrored in the key mappings configuration
                FIX = {
